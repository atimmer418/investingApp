...
import { InvestmentScheduleComponent, InvestmentSchedule } from '../investment-schedule/investment-schedule.component';
...
interface SurveyQuestion {
  ...
  answer: string | null;
  isInvestmentScheduleStep?: boolean; // Flag for the investment schedule setup
}
